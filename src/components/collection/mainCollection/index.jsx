...
const CollectionProducts = dynamic(() => import("./CollectionProducts"), {
  loading: () => <div />,
});
const FilterBtn = dynamic(() => import("./FilterBtn"), {
  loading: () => <div />,
});
const FilterPaginate = dynamic(() => import("./FilterPaginate"), {
  loading: () => <div />,
});
const FilterSort = dynamic(() => import("./FilterSort"), {
  loading: () => <div />,
});
const GridBox = dynamic(() => import("./GridBox"), { loading: () => <div /> });
const OfferBanner = dynamic(() => import("./OfferBanner"), {
  loading: () => <div />,
});
const PopUpSidebar = dynamic(() => import("./PopUpSidebar"), {
  loading: () => <div />,
});
